...
def generate_layout_and_data(width=80, height=80, num_rooms=18, loop_back_chance=0.20, scale=6):
    ...
    # 5. Burn down into a 2D binary grid for PNG generation
    ...
    # Save TXT
    with open("dungeon_data.txt", "w") as f:
        json.dump(output_data, f, indent=4)

    return json.dumps(output_data, indent=4)

# Execute the layout generator
json_output = generate_layout_and_data()
